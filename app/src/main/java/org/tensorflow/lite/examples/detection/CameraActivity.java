...
public abstract class CameraActivity extends AppCompatActivity
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        voice_onSwitch = findViewById(R.id.voice_switch);
    ...
    /**
     * Callback para android.hardware.Camera API
     */
    @Override
    ...
    private void requestPermission() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (shouldShowRequestPermissionRationale(PERMISSION_CAMERA)) {
                Toast.makeText(
                        CameraActivity.this,
                        "Camera permission is required for this facemask detector.",
                        Toast.LENGTH_LONG)
                        .show();
            }
...
//        }
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.voice_switch) {
            Switch voice_switch = (Switch)findViewById(R.id.voice_switch);
            Boolean switch_on = voice_switch.isChecked();
            voice_onSwitch = voice_switch;
            setVoiceOption(switch_on);
        }
    }
    ...
    protected abstract void setVoiceOption(Boolean voice_on);
